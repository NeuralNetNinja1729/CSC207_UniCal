...
public class DeleteEventInteractorTest {
    ...
    public void testDeleteEventT() throws Exception {
        ...
        DeleteEventInputData inputData = new DeleteEventInputData(new Event("Crazy Event!", LocalDate.of(2024, 11, 30), notion));
    ...
    public void testGetEventID() throws Exception {
        ...
        Event mockEvent = new Event("Crazy Event!", LocalDate.of(2024, 11, 30), notionCalendar);
